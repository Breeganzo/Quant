...
Model answer: A strong answer uses one decision workflow such as: Realistic backtest evaluation.. Then it states one realistic failure mode: Ignoring costs in reported performance., and one detection check.
