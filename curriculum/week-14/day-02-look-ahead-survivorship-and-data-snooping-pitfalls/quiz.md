...
### Q1 (basic)
Interview question: Explain look-ahead, survivorship, and data snooping pitfalls in plain language for a trading or risk audience.

Model answer: A strong answer defines look-ahead, survivorship, and data snooping pitfalls, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
