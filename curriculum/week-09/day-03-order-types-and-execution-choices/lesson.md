# Week 09 Wed: Order types and execution choices

**Estimated time:** 10 hours

## Daily Mission
This day belongs to the week theme "Finance Core I: market microstructure, execution, slippage, and transaction costs". Your objective is to understand, apply, and communicate order types and execution choices in a way a quant team would trust.

## Continuity Map
- Previous day focus: Bid-ask spread, liquidity, and adverse selection
- Today's focus: Order types and execution choices
- Next day bridge: Transaction costs and slippage models
...
Order types and execution choices is part of real quant work inside finance core i: market microstructure, execution, slippage, and transaction costs research, trading, or risk workflows.

## Concept Build (Intuition -> Technical -> Market Use)
1. Intuition: Reference price between best bid and ask.
2. Technical frame: Build order types and execution choices from intuition to implementation: define the core mechanism, map it to measurable outputs, and state one assumption that can break in live deployment. (key formulas/workflows: Mid Price, Effective Spread, Turnover).
3. Market interpretation: Execution quality benchmarking.. Run one compact, reproducible example for order types and execution choices and explain both the signal and the main failure mode a quant team should watch.
4. Failure mode check: Comparing fills to stale mid prices.

## Real-World Solved Case (Step-by-Step)
- Step 1 (Problem framing): Define the desk decision and why order types and execution choices is relevant.
...
## Practice Problems
- Explain order types and execution choices in one paragraph without jargon.
- Write down one topic-specific formula or workflow for order types and execution choices from memory.
- Connect order types and execution choices to one realistic trading, portfolio, risk, or research decision.
...
1. What is the core intuition behind order types and execution choices?
...
- Design one topic-specific analysis for order types and execution choices instead of reusing generic volatility-only metrics.
- Document one implementation risk and one robustness check before finalizing conclusions.

## Coding Task
Simulate one execution or turnover scenario for order types and execution choices and quantify its cost impact.
...
## Interview Drill
- Q1: Explain order types and execution choices to a non-technical stakeholder in 3 sentences.
- Q2: Give one failure case where this concept can produce misleading confidence.
- Q3: Show one concrete link from this concept to trading, portfolio construction, risk, or research quality.

## Reflection Prompt
What from order types and execution choices is now evidence-backed in your notes, and what still needs a focused retry?
