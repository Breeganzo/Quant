...
### Q1 (basic)
Interview question: Explain market microstructure and order books in plain language for a trading or risk audience.

Model answer: A strong answer defines market microstructure and order books, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
