...
Model answer: A strong answer defines numpy arrays, vectorization, and speed intuition, gives one concrete market example, and states why the concept improves decisions under uncertainty.
