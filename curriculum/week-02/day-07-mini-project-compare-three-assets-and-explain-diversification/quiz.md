...
Model answer: A strong answer defines mini project: compare three assets and explain diversification, gives one concrete market example, and states why the concept improves decisions under uncertainty.
