...
Model answer: A strong answer uses one decision workflow such as: Portfolio backtest baseline.. Then it states one realistic failure mode: Using contemporaneous (leaky) weights., and one detection check.
