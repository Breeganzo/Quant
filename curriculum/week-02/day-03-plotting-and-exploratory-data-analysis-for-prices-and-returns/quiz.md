...
### Q1 (basic)
Interview question: Explain plotting and exploratory data analysis for prices and returns in plain language for a trading or risk audience.

Model answer: A strong answer defines plotting and exploratory data analysis for prices and returns, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
