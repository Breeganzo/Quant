...
- Design one topic-specific analysis for portfolio theory, efficient frontier, and sharpe ratio intuition instead of reusing generic volatility-only metrics.
