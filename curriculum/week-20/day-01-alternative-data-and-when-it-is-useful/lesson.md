...
- Step 1 (Problem framing): Define the desk decision and why alternative data and when it is useful is relevant.
...
- Tie the workflow back to alternative data and when it is useful with one concrete business/research decision.

## Coding Task
Build a small AI-assisted workflow for alternative data and when it is useful with explicit citation and hallucination checks.
...
## Reflection Prompt
What from alternative data and when it is useful is now evidence-backed in your notes, and what still needs a focused retry?
