...
### Q1 (basic)
Interview question: Explain alternative data and when it is useful in plain language for a trading or risk audience.

Model answer: A strong answer defines alternative data and when it is useful, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
