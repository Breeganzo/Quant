...
### Q1 (basic)
Interview question: Explain review and checkpoint in plain language for a trading or risk audience.

Model answer: A strong answer defines review and checkpoint, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
