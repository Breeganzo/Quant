...
### Q1 (basic)
Interview question: Explain capm and beta intuition in plain language for a trading or risk audience.

Model answer: A strong answer defines capm and beta intuition, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
