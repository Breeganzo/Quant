# Week 10 Mon: Markowitz portfolio intuition

**Estimated time:** 8 hours

## Daily Mission
This day belongs to the week theme "Finance Core II: portfolio theory, CAPM, factor investing, and optimization". Your objective is to understand, apply, and communicate markowitz portfolio intuition in a way a quant team would trust.

## Continuity Map
- Week kickoff: establish baseline intuition and key definitions before moving into formal detail.
- Today's focus: Markowitz portfolio intuition
- Next day bridge: Efficient frontier and Sharpe ratio
...
2. Technical frame: Start with intuition for markowitz portfolio intuition, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around markowitz portfolio intuition and explain what the output would mean for a trader or risk analyst.
...
1. What is the core intuition behind markowitz portfolio intuition?
...
- Topic-specific formula: write one formula central to markowitz portfolio intuition and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: markowitz portfolio intuition.

## Interview Drill
- Q1: Explain markowitz portfolio intuition to a non-technical stakeholder in 3 sentences.
- Q2: Give one failure case where this concept can produce misleading confidence.
- Q3: Show one concrete link from this concept to trading, portfolio construction, or risk control.

## Reflection Prompt
What from markowitz portfolio intuition felt truly clear, and what still needs a slower revisit?
