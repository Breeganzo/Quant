...
### Q1 (basic)
Interview question: Explain markowitz portfolio intuition in plain language for a trading or risk audience.

Model answer: A strong answer defines markowitz portfolio intuition, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
