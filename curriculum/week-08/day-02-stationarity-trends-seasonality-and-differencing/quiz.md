...
Model answer: A strong answer defines stationarity, trends, seasonality, and differencing, gives one concrete market example, and states why the concept improves decisions under uncertainty.
