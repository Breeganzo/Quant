...
Model answer: A strong answer uses one decision workflow such as: Baseline univariate forecasting.. Then it states one realistic failure mode: Choosing orders without diagnostics., and one detection check.
