...
Model answer: A strong answer defines walk-forward validation and forecast error metrics, gives one concrete market example, and states why the concept improves decisions under uncertainty.
