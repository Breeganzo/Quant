...
Model answer: A strong answer defines stress testing and scenario design, gives one concrete market example, and states why the concept improves decisions under uncertainty.
