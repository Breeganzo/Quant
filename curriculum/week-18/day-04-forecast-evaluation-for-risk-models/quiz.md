...
Model answer: A strong answer defines forecast evaluation for risk models, gives one concrete market example, and states why the concept improves decisions under uncertainty.
