...
Model answer: A strong answer defines convexity and nonlinear bond behavior, gives one concrete market example, and states why the concept improves decisions under uncertainty.
