...
Model answer: A strong answer uses one decision workflow such as: Credit-risk pricing comparison.. Then it states one realistic failure mode: Ignoring liquidity premium component., one detection check, and one mitigation action.
