...
Model answer: A strong answer uses one decision workflow such as: Curve construction and pricing.. Then it states one realistic failure mode: Mixing compounding conventions., one detection check, and one mitigation action.
