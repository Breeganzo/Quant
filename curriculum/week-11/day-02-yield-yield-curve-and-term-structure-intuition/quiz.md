...
Model answer: A strong answer defines yield, yield curve, and term structure intuition, gives one concrete market example, and states why the concept improves decisions under uncertainty.
