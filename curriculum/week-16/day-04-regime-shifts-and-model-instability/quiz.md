...
### Q1 (basic)
Interview question: Explain regime shifts and model instability in plain language for a trading or risk audience.

Model answer: A strong answer defines regime shifts and model instability, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
