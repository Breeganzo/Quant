...
Model answer: A strong answer defines regime shifts and model instability, gives one concrete market example, and states why the concept improves decisions under uncertainty.
