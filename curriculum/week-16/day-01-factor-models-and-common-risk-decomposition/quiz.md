...
Model answer: A strong answer defines factor models and common risk decomposition, gives one concrete market example, and states why the concept improves decisions under uncertainty.
