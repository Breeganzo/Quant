...
### Q1 (basic)
Interview question: Explain residual signals and relative-value intuition in plain language for a trading or risk audience.

Model answer: A strong answer defines residual signals and relative-value intuition, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
