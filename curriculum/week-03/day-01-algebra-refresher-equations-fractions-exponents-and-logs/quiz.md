...
Model answer: A strong answer defines algebra refresher: equations, fractions, exponents, and logs, gives one concrete market example, and states why the concept improves decisions under uncertainty.
