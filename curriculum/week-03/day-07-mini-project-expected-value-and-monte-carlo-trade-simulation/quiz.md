...
Model answer: A strong answer defines mini project: expected value and monte carlo trade simulation, gives one concrete market example, and states why the concept improves decisions under uncertainty.
