...
### Q1 (basic)
Interview question: Explain apis, json, conditional probability, and bayes intuition in plain language for a trading or risk audience.

Model answer: A strong answer defines apis, json, conditional probability, and bayes intuition, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
