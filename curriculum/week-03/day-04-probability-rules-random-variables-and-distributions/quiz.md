...
Model answer: A strong answer defines probability rules, random variables, and distributions, gives one concrete market example, and states why the concept improves decisions under uncertainty.
