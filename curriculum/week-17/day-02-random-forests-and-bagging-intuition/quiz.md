...
Model answer: A strong answer uses one decision workflow such as: Variance reduction.. Then it states one realistic failure mode: Assuming bias also vanishes automatically., one detection check, and one mitigation action.
