...
1. Intuition: describe mini lab: ai-assisted research memo in plain language before touching formulas.
2. Technical frame: Start with intuition for mini lab: ai-assisted research memo, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around mini lab: ai-assisted research memo and explain what the output would mean for a trader or risk analyst.
...
- Topic-specific formula: write one formula central to mini lab: ai-assisted research memo and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: mini lab: ai-assisted research memo.
...
## Reflection Prompt
What from mini lab: ai-assisted research memo felt truly clear, and what still needs a slower revisit?
