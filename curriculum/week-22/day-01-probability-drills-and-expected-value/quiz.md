...
### Q1 (basic)
Interview question: Explain probability drills and expected value in plain language for a trading or risk audience.

Model answer: A strong answer defines probability drills and expected value, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
