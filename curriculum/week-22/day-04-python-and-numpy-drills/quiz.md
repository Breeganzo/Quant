...
Model answer: A strong answer defines python and numpy drills, gives one concrete market example, and states why the concept improves decisions under uncertainty.
