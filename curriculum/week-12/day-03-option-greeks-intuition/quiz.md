...
Model answer: A strong answer uses one decision workflow such as: Hedge-ratio baseline.. Then it states one realistic failure mode: Treating delta as constant., one detection check, and one mitigation action.
