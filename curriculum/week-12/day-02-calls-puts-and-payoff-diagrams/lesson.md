# Week 12 Tue: Calls, puts, and payoff diagrams

**Estimated time:** 8 hours

## Daily Mission
This day belongs to the week theme "Finance Core IV: derivatives, options, Greeks, hedging, and risk management". Your objective is to understand, apply, and communicate calls, puts, and payoff diagrams in a way a quant team would trust.

## Continuity Map
- Previous day focus: Forwards, futures, and option payoffs
- Today's focus: Calls, puts, and payoff diagrams
- Next day bridge: Option Greeks intuition
...
2. Technical frame: Start with intuition for calls, puts, and payoff diagrams, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around calls, puts, and payoff diagrams and explain what the output would mean for a trader or risk analyst.
...
1. What is the core intuition behind calls, puts, and payoff diagrams?
...
- Topic-specific formula: write one formula central to calls, puts, and payoff diagrams and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: calls, puts, and payoff diagrams.

## Interview Drill
- Q1: Explain calls, puts, and payoff diagrams to a non-technical stakeholder in 3 sentences.
- Q2: Give one failure case where this concept can produce misleading confidence.
- Q3: Show one concrete link from this concept to trading, portfolio construction, or risk control.

## Reflection Prompt
What from calls, puts, and payoff diagrams felt truly clear, and what still needs a slower revisit?
