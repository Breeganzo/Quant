...
- Step 1 (Problem framing): Define the desk decision and why unsupervised learning overview is relevant.
...
- Design one topic-specific analysis for unsupervised learning overview instead of reusing generic volatility-only metrics.
- Document one implementation risk and one robustness check before finalizing conclusions.

## Coding Task
Train a baseline classifier/regressor for unsupervised learning overview on market-derived features and report one robust metric beyond accuracy.
...
## Reflection Prompt
What from unsupervised learning overview is now evidence-backed in your notes, and what still needs a focused retry?
