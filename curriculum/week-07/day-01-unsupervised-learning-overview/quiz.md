...
Model answer: A strong answer defines unsupervised learning overview, gives one concrete market example, and states why the concept improves decisions under uncertainty.
