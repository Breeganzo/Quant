...
Model answer: A strong answer defines reset your toolkit: numbers, variables, returns, and compounding, gives one concrete market example, and states why the concept improves decisions under uncertainty.
