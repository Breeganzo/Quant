...
Model answer: A strong answer defines descriptive statistics, sampling intuition, and visualizing market data, gives one concrete market example, and states why the concept improves decisions under uncertainty.
