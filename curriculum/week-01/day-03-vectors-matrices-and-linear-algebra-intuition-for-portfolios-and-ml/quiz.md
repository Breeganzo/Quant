...
Model answer: A strong answer defines vectors, matrices, and linear algebra intuition for portfolios and ml, gives one concrete market example, and states why the concept improves decisions under uncertainty.
