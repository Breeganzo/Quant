...
Model answer: A strong answer uses one decision workflow such as: Multi-period analytics.. Then it states one realistic failure mode: Mixing with simple returns without context., and one detection check.
