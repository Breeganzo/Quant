...
### Q1 (basic)
Interview question: Explain sop structure: past, pivot, proof, future in plain language for a trading or risk audience.

Model answer: A strong answer defines sop structure: past, pivot, proof, future, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
