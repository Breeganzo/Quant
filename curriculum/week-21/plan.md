# Week 21: Admissions Track I: target programs, scholarships, SOP structure, and recommendation strategy
...
## Quiz / Checkpoint
Can you explain why each target school makes sense for your background and goals?

## Weekend Revision and Mini Project
Produce a draft application packet: SOP outline, CV draft, shortlist, scholarship tracker.

## Admissions Track
This entire week is the admissions track. Start drafting actual artifacts.

## Interview / Job Track
Practice the master's admissions question: why this field, why now, why you?

## Interview Prep Questions and Model Answers
### Q: Explain program fit in plain English.
A: Program fit should first be explained as an intuitive idea before any notation. In quant work it matters because it shapes how we measure, compare, or model financial behavior inside admissions track i: target programs, scholarships, sop structure, and recommendation strategy tasks.

### Q: What is a common mistake when applying scholarship targeting in finance?
A: A common mistake is to use scholarship targeting mechanically while ignoring assumptions, data quality, or market frictions. In finance, even a mathematically correct method can fail if the data are noisy, the sample is unstable, or the implementation is unrealistic.

### Q: How would you test whether your work on admissions track i: target programs, scholarships, sop structure, and recommendation strategy is robust?
A: I would start with a simple baseline, check sensitivity to assumptions, inspect subperiod stability, and verify that results survive realistic costs or constraints. If the topic involves prediction or backtesting, I would also guard against leakage and ensure evaluation is aligned with how the model would be used live.

### Q: Why does narrative coherence matter for a quant trader or quant researcher?
A: Narrative coherence matters because it changes either signal quality, risk control, implementation quality, or communication with a desk or portfolio manager. A useful quant answer should always connect the concept to a real decision rather than leaving it as theory only.
