...
Model answer: A strong answer defines feature engineering from price and volume data, gives one concrete market example, and states why the concept improves decisions under uncertainty.
