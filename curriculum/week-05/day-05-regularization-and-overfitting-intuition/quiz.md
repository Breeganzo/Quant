...
Model answer: A strong answer defines regularization and overfitting intuition, gives one concrete market example, and states why the concept improves decisions under uncertainty.
