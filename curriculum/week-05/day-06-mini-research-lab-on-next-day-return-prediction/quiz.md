...
Model answer: A strong answer defines mini research lab on next-day return prediction, gives one concrete market example, and states why the concept improves decisions under uncertainty.
