...
Model answer: A strong answer defines linear regression as an ml baseline, gives one concrete market example, and states why the concept improves decisions under uncertainty.
