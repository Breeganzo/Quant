...
Model answer: A strong answer defines mini lab: classify positive versus negative future returns, gives one concrete market example, and states why the concept improves decisions under uncertainty.
