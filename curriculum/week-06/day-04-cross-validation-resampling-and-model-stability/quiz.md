...
Model answer: A strong answer defines cross-validation, resampling, and model stability, gives one concrete market example, and states why the concept improves decisions under uncertainty.
