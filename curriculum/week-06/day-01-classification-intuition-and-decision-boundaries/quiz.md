...
### Q1 (basic)
Interview question: Explain classification intuition and decision boundaries in plain language for a trading or risk audience.

Model answer: A strong answer defines classification intuition and decision boundaries, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
