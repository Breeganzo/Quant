...
Model answer: A strong answer uses one decision workflow such as: Binary event prediction.. Then it states one realistic failure mode: Thresholding without business-cost calibration., and one detection check.
