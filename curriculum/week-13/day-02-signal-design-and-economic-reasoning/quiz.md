...
Model answer: A strong answer defines signal design and economic reasoning, gives one concrete market example, and states why the concept improves decisions under uncertainty.
