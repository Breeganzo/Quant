...
- Step 1 (Problem framing): Define the desk decision and why review and refinement is relevant.
...
- Design one topic-specific analysis for review and refinement instead of reusing generic volatility-only metrics.
- Document one implementation risk and one robustness check before finalizing conclusions.

## Coding Task
Create a hypothesis test workflow for review and refinement and log one anti-leakage guardrail.
...
## Reflection Prompt
What from review and refinement is now evidence-backed in your notes, and what still needs a focused retry?
