...
Model answer: A strong answer defines mini lab: define one alpha hypothesis cleanly, gives one concrete market example, and states why the concept improves decisions under uncertainty.
