...
Model answer: A strong answer uses one decision workflow such as: Case-study defense quality.. Then it states one realistic failure mode: Narrative claims without references., one detection check, and one mitigation action.
