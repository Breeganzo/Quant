...
### Q1 (basic)
Interview question: Explain mock presentation day in plain language for a trading or risk audience.

Model answer: A strong answer defines mock presentation day, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
