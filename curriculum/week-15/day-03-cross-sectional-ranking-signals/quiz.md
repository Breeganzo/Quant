...
### Q1 (basic)
Interview question: Explain cross-sectional ranking signals in plain language for a trading or risk audience.

Model answer: A strong answer defines cross-sectional ranking signals, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
