...
Model answer: A strong answer defines signal combination and normalization, gives one concrete market example, and states why the concept improves decisions under uncertainty.
