...
2. Technical frame: Start with intuition for review and critique, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around review and critique and explain what the output would mean for a trader or risk analyst.
...
## Coding Task
Implement one notebook cell or small script focused on: review and critique.
...
## Reflection Prompt
What from review and critique felt truly clear, and what still needs a slower revisit?
