...
### Q1 (basic)
Interview question: Explain capstone presentation day in plain language for a trading or risk audience.

Model answer: A strong answer defines capstone presentation day, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
