...
## Core Explanation
Start with intuition for turnover, holding period, and capacity intuition, then restate it using the formal quantitative language used in finance and ML.

## Worked Example
Build one small finance example around turnover, holding period, and capacity intuition and explain what the output would mean for a trader or risk analyst.
