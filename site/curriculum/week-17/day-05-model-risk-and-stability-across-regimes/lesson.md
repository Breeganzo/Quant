...
## Core Explanation
Start with intuition for model risk and stability across regimes, then restate it using the formal quantitative language used in finance and ML.

## Worked Example
Build one small finance example around model risk and stability across regimes and explain what the output would mean for a trader or risk analyst.
