...
Model answer: A strong answer defines mini lab: ai-assisted research memo, gives one concrete market example, and states why the concept improves decisions under uncertainty.
