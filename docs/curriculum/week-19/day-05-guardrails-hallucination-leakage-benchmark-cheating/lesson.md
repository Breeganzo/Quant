...
- Tie the workflow back to guardrails: hallucination, leakage, benchmark cheating with one concrete business/research decision.

## Coding Task
Build a small AI-assisted workflow for guardrails: hallucination, leakage, benchmark cheating with explicit citation and hallucination checks.
...
## Reflection Prompt
What from guardrails: hallucination, leakage, benchmark cheating is now evidence-backed in your notes, and what still needs a focused retry?
