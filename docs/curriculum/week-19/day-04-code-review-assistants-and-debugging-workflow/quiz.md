...
Model answer: A strong answer defines code review assistants and debugging workflow, gives one concrete market example, and states why the concept improves decisions under uncertainty.
