...
### Q1 (basic)
Interview question: Explain mini lab: define one alpha hypothesis cleanly in plain language for a trading or risk audience.

Model answer: A strong answer defines mini lab: define one alpha hypothesis cleanly, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
