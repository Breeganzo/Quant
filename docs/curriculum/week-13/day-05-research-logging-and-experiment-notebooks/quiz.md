...
Model answer: A strong answer uses one decision workflow such as: Early alpha hypothesis screening.. Then it states one realistic failure mode: Treating a single-period IC as stable edge., and one detection check.
