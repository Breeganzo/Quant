...
Model answer: A strong answer uses one decision workflow such as: Pipeline data audit.. Then it states one realistic failure mode: Using post-event data in training., and one detection check.
