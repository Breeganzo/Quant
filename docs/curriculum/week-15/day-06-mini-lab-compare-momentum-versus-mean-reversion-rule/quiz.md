...
Model answer: A strong answer defines mini lab: compare momentum versus mean reversion rule, gives one concrete market example, and states why the concept improves decisions under uncertainty.
