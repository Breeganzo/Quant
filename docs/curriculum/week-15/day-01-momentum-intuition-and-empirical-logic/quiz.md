...
Model answer: A strong answer defines momentum intuition and empirical logic, gives one concrete market example, and states why the concept improves decisions under uncertainty.
