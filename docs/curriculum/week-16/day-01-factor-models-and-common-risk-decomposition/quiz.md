...
### Q1 (basic)
Interview question: Explain factor models and common risk decomposition in plain language for a trading or risk audience.

Model answer: A strong answer defines factor models and common risk decomposition, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
