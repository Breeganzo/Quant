...
### Q1 (basic)
Interview question: Explain cointegration and spread logic in plain language for a trading or risk audience.

Model answer: A strong answer defines cointegration and spread logic, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
