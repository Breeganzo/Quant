...
Model answer: A strong answer defines cross-sectional portfolio construction, gives one concrete market example, and states why the concept improves decisions under uncertainty.
