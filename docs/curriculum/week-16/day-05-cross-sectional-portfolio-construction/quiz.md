...
Model answer: A strong answer uses one decision workflow such as: Pairs trading mean-reversion setup.. Then it states one realistic failure mode: Skipping hedge-ratio estimation stability checks., and one detection check.
