...
2. Technical frame: Start with intuition for volatility clustering and stylized facts, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around volatility clustering and stylized facts and explain what the output would mean for a trader or risk analyst.
...
- Topic-specific formula: write one formula central to volatility clustering and stylized facts and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: volatility clustering and stylized facts.
...
## Reflection Prompt
What from volatility clustering and stylized facts felt truly clear, and what still needs a slower revisit?
