...
Model answer: A strong answer defines garch intuition and limitations, gives one concrete market example, and states why the concept improves decisions under uncertainty.
