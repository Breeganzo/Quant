...
Model answer: A strong answer uses one decision workflow such as: Diversification diagnostics.. Then it states one realistic failure mode: Miscaligned timestamps inflate noise., and one detection check.
