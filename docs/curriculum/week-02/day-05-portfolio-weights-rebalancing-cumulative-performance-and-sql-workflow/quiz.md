...
Model answer: A strong answer defines portfolio weights, rebalancing, cumulative performance, and sql workflow, gives one concrete market example, and states why the concept improves decisions under uncertainty.
