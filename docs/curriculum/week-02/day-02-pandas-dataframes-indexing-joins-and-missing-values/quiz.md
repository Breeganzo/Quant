...
Model answer: A strong answer defines pandas dataframes, indexing, joins, and missing values, gives one concrete market example, and states why the concept improves decisions under uncertainty.
