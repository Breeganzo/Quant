...
Model answer: A strong answer defines prediction problems in finance: what are we forecasting?, gives one concrete market example, and states why the concept improves decisions under uncertainty.
