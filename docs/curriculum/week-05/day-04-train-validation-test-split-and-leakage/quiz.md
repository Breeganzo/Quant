...
Model answer: A strong answer defines train, validation, test split and leakage, gives one concrete market example, and states why the concept improves decisions under uncertainty.
