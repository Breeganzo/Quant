# Week 22 Wed: Linear algebra and optimization drills

**Estimated time:** 8 hours

## Daily Mission
This day belongs to the week theme "Interview Prep I: probability, statistics, mental math, Python, SQL, and markets discussion". Your objective is to understand, apply, and communicate linear algebra and optimization drills in a way a quant team would trust.

## Continuity Map
- Previous day focus: Statistics and regression drills
- Today's focus: Linear algebra and optimization drills
- Next day bridge: Python and NumPy drills
...
2. Technical frame: Start with intuition for linear algebra and optimization drills, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around linear algebra and optimization drills and explain what the output would mean for a trader or risk analyst.
...
1. What is the core intuition behind linear algebra and optimization drills?
...
- Topic-specific formula: write one formula central to linear algebra and optimization drills and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: linear algebra and optimization drills.

## Interview Drill
- Q1: Explain linear algebra and optimization drills to a non-technical stakeholder in 3 sentences.
- Q2: Give one failure case where this concept can produce misleading confidence.
- Q3: Show one concrete link from this concept to trading, portfolio construction, or risk control.

## Reflection Prompt
What from linear algebra and optimization drills felt truly clear, and what still needs a slower revisit?
