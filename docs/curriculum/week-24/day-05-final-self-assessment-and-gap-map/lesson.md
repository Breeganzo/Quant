...
- Design one topic-specific analysis for final self-assessment and gap map instead of reusing generic volatility-only metrics.
...
## Reflection Prompt
What from final self-assessment and gap map is now evidence-backed in your notes, and what still needs a focused retry?
