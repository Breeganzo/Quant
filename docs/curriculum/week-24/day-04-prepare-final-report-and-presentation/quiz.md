...
### Q1 (basic)
Interview question: Explain prepare final report and presentation in plain language for a trading or risk audience.

Model answer: A strong answer defines prepare final report and presentation, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
