...
Model answer: A strong answer defines implement pipeline and verify assumptions, gives one concrete market example, and states why the concept improves decisions under uncertainty.
