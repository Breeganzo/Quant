...
Model answer: A strong answer defines calls, puts, and payoff diagrams, gives one concrete market example, and states why the concept improves decisions under uncertainty.
