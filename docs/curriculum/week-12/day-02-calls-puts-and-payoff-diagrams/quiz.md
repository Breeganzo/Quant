...
### Q1 (basic)
Interview question: Explain calls, puts, and payoff diagrams in plain language for a trading or risk audience.

Model answer: A strong answer defines calls, puts, and payoff diagrams, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
