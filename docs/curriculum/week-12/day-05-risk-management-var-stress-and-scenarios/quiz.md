...
### Q1 (basic)
Interview question: Explain risk management: var, stress, and scenarios in plain language for a trading or risk audience.

Model answer: A strong answer defines risk management: var, stress, and scenarios, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
