...
- Step 1 (Problem framing): Define the desk decision and why option greeks intuition is relevant.
...
- Step 3 (Method): Apply Delta or a directly related workflow on a reproducible sample.
- Step 4 (Result): Report one quantitative output and one practical interpretation for research, trading, or risk.
- Step 5 (Caveat): Document one failure mode: Treating delta as constant.
