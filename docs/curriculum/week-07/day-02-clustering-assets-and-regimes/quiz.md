...
Model answer: A strong answer defines clustering assets and regimes, gives one concrete market example, and states why the concept improves decisions under uncertainty.
