...
Model answer: A strong answer defines order types and execution choices, gives one concrete market example, and states why the concept improves decisions under uncertainty.
