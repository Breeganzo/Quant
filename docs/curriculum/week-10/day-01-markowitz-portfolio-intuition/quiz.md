...
Model answer: A strong answer defines markowitz portfolio intuition, gives one concrete market example, and states why the concept improves decisions under uncertainty.
