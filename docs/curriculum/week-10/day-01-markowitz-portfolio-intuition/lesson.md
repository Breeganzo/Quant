...
- Step 1 (Problem framing): Define the desk decision and why markowitz portfolio intuition is relevant.
...
- Design one topic-specific analysis for markowitz portfolio intuition instead of reusing generic volatility-only metrics.
- Document one implementation risk and one robustness check before finalizing conclusions.

## Coding Task
Compute a risk-aware allocation for markowitz portfolio intuition and explain one concentration risk from the resulting weights.
...
## Reflection Prompt
What from markowitz portfolio intuition is now evidence-backed in your notes, and what still needs a focused retry?
