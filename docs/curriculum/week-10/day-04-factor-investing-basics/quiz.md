...
Model answer: A strong answer defines factor investing basics, gives one concrete market example, and states why the concept improves decisions under uncertainty.
