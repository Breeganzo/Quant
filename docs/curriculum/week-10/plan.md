# Week 10: Finance Core II: portfolio theory, CAPM, factor investing, and optimization
...
## Quiz / Checkpoint
Can you explain factor investing as a systematic bet on common drivers rather than individual stock stories?

## Weekend Revision and Mini Project
Estimate simple factor exposures or factor-like group comparisons for a small asset set.

## Admissions Track
Begin a scholarship matrix with application opening dates, essays, and funding type.

## Interview / Job Track
Practice CAPM and beta explanations without equations first.

## Interview Prep Questions and Model Answers
### Q: Explain mean-variance optimization in plain English.
A: Mean-variance optimization should first be explained as an intuitive idea before any notation. In quant work it matters because it shapes how we measure, compare, or model financial behavior inside finance core ii: portfolio theory, capm, factor investing, and optimization tasks.

### Q: What is a common mistake when applying sharpe ratio in finance?
A: A common mistake is to use sharpe ratio mechanically while ignoring assumptions, data quality, or market frictions. In finance, even a mathematically correct method can fail if the data are noisy, the sample is unstable, or the implementation is unrealistic.

### Q: How would you test whether your work on finance core ii: portfolio theory, capm, factor investing, and optimization is robust?
...
### Q: Why does capm matter for a quant trader or quant researcher?
A: CAPM matters because it changes either signal quality, risk control, implementation quality, or communication with a desk or portfolio manager. A useful quant answer should always connect the concept to a real decision rather than leaving it as theory only.
