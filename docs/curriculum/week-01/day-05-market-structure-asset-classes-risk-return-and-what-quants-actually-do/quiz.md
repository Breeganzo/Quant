...
Model answer: A strong answer uses one decision workflow such as: Liquidity-aware strategy design.. Then it states one realistic failure mode: Ignoring spread impact in high-turnover rules., one detection check, and one mitigation action.
