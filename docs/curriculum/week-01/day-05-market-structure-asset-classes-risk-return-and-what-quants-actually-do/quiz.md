...
Model answer: A strong answer defines market structure, asset classes, risk, return, and what quants actually do, gives one concrete market example, and states why the concept improves decisions under uncertainty.
