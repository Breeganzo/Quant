...
Model answer: A strong answer defines functions, control flow, probability intuition, and expected value, gives one concrete market example, and states why the concept improves decisions under uncertainty.
