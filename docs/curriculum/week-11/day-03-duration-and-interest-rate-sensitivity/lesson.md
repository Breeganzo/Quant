...
2. Technical frame: Start with intuition for duration and interest rate sensitivity, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around duration and interest rate sensitivity and explain what the output would mean for a trader or risk analyst.
4. Failure mode check: identify one way this concept is commonly misused in research or trading discussion.

## Practice Problems
- Explain duration and interest rate sensitivity in one paragraph without jargon.
- Write down the main formula or workflow for duration and interest rate sensitivity from memory.
- Connect duration and interest rate sensitivity to one trading, portfolio, or risk problem.
...
- Topic-specific formula: write one formula central to duration and interest rate sensitivity and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: duration and interest rate sensitivity.
...
## Reflection Prompt
What from duration and interest rate sensitivity felt truly clear, and what still needs a slower revisit?
