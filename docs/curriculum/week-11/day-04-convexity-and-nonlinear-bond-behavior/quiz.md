...
Model answer: A strong answer uses one decision workflow such as: Improve bond shock approximations.. Then it states one realistic failure mode: Ignoring convexity in volatile rate regimes., one detection check, and one mitigation action.
