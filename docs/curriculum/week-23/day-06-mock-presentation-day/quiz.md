...
Model answer: A strong answer defines mock presentation day, gives one concrete market example, and states why the concept improves decisions under uncertainty.
