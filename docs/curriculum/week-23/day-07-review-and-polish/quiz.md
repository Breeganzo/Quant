...
Model answer: A strong answer uses one decision workflow such as: Case-study defense quality.. Then it states one realistic failure mode: Narrative claims without references., and one detection check.
