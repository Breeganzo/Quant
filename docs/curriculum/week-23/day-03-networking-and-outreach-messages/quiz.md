...
### Q1 (basic)
Interview question: Explain networking and outreach messages in plain language for a trading or risk audience.

Model answer: A strong answer defines networking and outreach messages, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
