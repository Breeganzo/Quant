...
Model answer: A strong answer uses one decision workflow such as: Split quality scoring.. Then it states one realistic failure mode: Overfitting deep trees without pruning., and one detection check.
