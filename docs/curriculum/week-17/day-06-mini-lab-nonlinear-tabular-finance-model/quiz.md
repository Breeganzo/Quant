...
Model answer: A strong answer defines mini lab: nonlinear tabular finance model, gives one concrete market example, and states why the concept improves decisions under uncertainty.
