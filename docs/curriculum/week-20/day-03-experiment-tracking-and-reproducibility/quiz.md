...
### Q1 (basic)
Interview question: Explain experiment tracking and reproducibility in plain language for a trading or risk audience.

Model answer: A strong answer defines experiment tracking and reproducibility, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
