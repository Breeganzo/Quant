...
Model answer: A strong answer defines experiment tracking and reproducibility, gives one concrete market example, and states why the concept improves decisions under uncertainty.
