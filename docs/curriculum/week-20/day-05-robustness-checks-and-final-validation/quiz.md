...
### Q1 (basic)
Interview question: Explain robustness checks and final validation in plain language for a trading or risk audience.

Model answer: A strong answer defines robustness checks and final validation, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
