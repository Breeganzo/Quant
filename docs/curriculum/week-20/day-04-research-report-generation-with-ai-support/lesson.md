...
1. Intuition: describe research report generation with ai support in plain language before touching formulas.
2. Technical frame: Start with intuition for research report generation with ai support, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around research report generation with ai support and explain what the output would mean for a trader or risk analyst.
...
- Topic-specific formula: write one formula central to research report generation with ai support and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: research report generation with ai support.
...
## Reflection Prompt
What from research report generation with ai support felt truly clear, and what still needs a slower revisit?
