...
- Tie the workflow back to capstone review and write-up with one concrete business/research decision.

## Coding Task
Build a small AI-assisted workflow for capstone review and write-up with explicit citation and hallucination checks.
