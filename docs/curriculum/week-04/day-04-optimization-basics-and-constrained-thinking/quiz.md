...
Model answer: A strong answer uses one decision workflow such as: Portfolio optimization setup.. Then it states one realistic failure mode: Ignoring feasibility checks before solving., one detection check, and one mitigation action.
