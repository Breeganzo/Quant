...
Model answer: A strong answer defines optimization basics and constrained thinking, gives one concrete market example, and states why the concept improves decisions under uncertainty.
