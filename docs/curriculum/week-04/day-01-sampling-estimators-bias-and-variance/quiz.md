...
Model answer: A strong answer defines sampling, estimators, bias, and variance, gives one concrete market example, and states why the concept improves decisions under uncertainty.
