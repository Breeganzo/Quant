...
Model answer: A strong answer defines capstone build day, gives one concrete market example, and states why the concept improves decisions under uncertainty.
