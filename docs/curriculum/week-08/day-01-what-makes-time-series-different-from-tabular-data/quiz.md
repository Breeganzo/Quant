...
Model answer: A strong answer defines what makes time series different from tabular data?, gives one concrete market example, and states why the concept improves decisions under uncertainty.
