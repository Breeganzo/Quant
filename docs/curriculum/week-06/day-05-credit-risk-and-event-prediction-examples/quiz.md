...
### Q1 (basic)
Interview question: Explain credit risk and event prediction examples in plain language for a trading or risk audience.

Model answer: A strong answer defines credit risk and event prediction examples, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
