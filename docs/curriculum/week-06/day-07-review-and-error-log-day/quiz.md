...
Model answer: A strong answer defines review and error-log day, gives one concrete market example, and states why the concept improves decisions under uncertainty.
