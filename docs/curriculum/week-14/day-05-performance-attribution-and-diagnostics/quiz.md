...
### Q1 (basic)
Interview question: Explain performance attribution and diagnostics in plain language for a trading or risk audience.

Model answer: A strong answer defines performance attribution and diagnostics, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
