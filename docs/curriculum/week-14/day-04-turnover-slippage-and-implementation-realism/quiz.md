...
### Q1 (basic)
Interview question: Explain turnover, slippage, and implementation realism in plain language for a trading or risk audience.

Model answer: A strong answer defines turnover, slippage, and implementation realism, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
