...
Model answer: A strong answer defines turnover, slippage, and implementation realism, gives one concrete market example, and states why the concept improves decisions under uncertainty.
