# Week 14 Mon: Backtesting workflow from signal to trades

**Estimated time:** 8 hours

## Daily Mission
This day belongs to the week theme "Quant Workflow II: backtesting architecture, position sizing, and performance attribution". Your objective is to understand, apply, and communicate backtesting workflow from signal to trades in a way a quant team would trust.

## Continuity Map
- Week kickoff: establish baseline intuition and key definitions before moving into formal detail.
- Today's focus: Backtesting workflow from signal to trades
- Next day bridge: Look-ahead, survivorship, and data snooping pitfalls
...
2. Technical frame: Start with intuition for backtesting workflow from signal to trades, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around backtesting workflow from signal to trades and explain what the output would mean for a trader or risk analyst.
...
1. What is the core intuition behind backtesting workflow from signal to trades?
...
- Topic-specific formula: write one formula central to backtesting workflow from signal to trades and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: backtesting workflow from signal to trades.

## Interview Drill
- Q1: Explain backtesting workflow from signal to trades to a non-technical stakeholder in 3 sentences.
- Q2: Give one failure case where this concept can produce misleading confidence.
- Q3: Show one concrete link from this concept to trading, portfolio construction, or risk control.

## Reflection Prompt
What from backtesting workflow from signal to trades felt truly clear, and what still needs a slower revisit?
