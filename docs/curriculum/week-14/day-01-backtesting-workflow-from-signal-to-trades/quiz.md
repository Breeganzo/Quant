...
Model answer: A strong answer defines backtesting workflow from signal to trades, gives one concrete market example, and states why the concept improves decisions under uncertainty.
