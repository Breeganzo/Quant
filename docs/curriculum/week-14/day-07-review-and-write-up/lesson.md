...
1. Intuition: describe review and write-up in plain language before touching formulas.
2. Technical frame: Start with intuition for review and write-up, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around review and write-up and explain what the output would mean for a trader or risk analyst.
...
- Topic-specific formula: write one formula central to review and write-up and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: review and write-up.
...
## Reflection Prompt
What from review and write-up felt truly clear, and what still needs a slower revisit?
