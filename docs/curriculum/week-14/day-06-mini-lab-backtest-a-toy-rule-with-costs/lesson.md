...
2. Technical frame: Start with intuition for mini lab: backtest a toy rule with costs, then restate it using the formal quantitative language used in finance and ML.
3. Market interpretation: Build one small finance example around mini lab: backtest a toy rule with costs and explain what the output would mean for a trader or risk analyst.
...
- Topic-specific formula: write one formula central to mini lab: backtest a toy rule with costs and explain every symbol.
...
## Coding Task
Implement one notebook cell or small script focused on: mini lab: backtest a toy rule with costs.
...
## Reflection Prompt
What from mini lab: backtest a toy rule with costs felt truly clear, and what still needs a slower revisit?
