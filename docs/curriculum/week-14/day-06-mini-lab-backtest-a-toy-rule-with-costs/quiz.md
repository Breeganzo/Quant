...
Model answer: A strong answer defines mini lab: backtest a toy rule with costs, gives one concrete market example, and states why the concept improves decisions under uncertainty.
