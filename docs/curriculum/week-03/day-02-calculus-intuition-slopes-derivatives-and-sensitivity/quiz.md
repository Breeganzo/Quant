...
Model answer: A strong answer defines calculus intuition: slopes, derivatives, and sensitivity, gives one concrete market example, and states why the concept improves decisions under uncertainty.
