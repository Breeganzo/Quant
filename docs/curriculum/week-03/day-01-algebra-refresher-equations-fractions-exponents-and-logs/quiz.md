...
Model answer: A strong answer uses one decision workflow such as: Evaluate expected payoff of a repeated decision rule.. Then it states one realistic failure mode: Ignoring tail risk while focusing only on mean payoff., and one detection check.
