...
### Q1 (basic)
Interview question: Explain scholarship matrix and funding logic in plain language for a trading or risk audience.

Model answer: A strong answer defines scholarship matrix and funding logic, gives one concrete workflow or market-facing decision example, and states one practical limitation that must be monitored.
